...
import com.jushi.mzbanner.transformer.CoverModeTransformer;
import com.jushi.mzbanner.transformer.ScaleYTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private BannerScrollChangeListener mBannerScrollChangeListener;
    ...
    public void setOnScrollChangeListener(BannerScrollChangeListener mBannerScrollChangeListener) {
        this.mBannerScrollChangeListener = mBannerScrollChangeListener;
    }
     ...
     * 解决滑动冲突
     */
    public interface BannerScrollChangeListener {
