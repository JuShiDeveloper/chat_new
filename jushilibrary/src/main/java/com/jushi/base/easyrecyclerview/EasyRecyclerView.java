package com.jushi.base.easyrecyclerview;
...
import com.jushi.base.easyrecyclerview.swipe.SwipeRefreshLayout;
...
public class EasyRecyclerView extends FrameLayout {
    ...
    private void initView() {
        ...
        mPtrLayout.setColorSchemeColors(getContext().getResources().getColor(R.color.colorAccent));
