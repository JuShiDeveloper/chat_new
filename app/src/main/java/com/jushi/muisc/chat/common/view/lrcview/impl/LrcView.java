package com.jushi.muisc.chat.common.view.lrcview.impl;
...
import com.jushi.muisc.chat.common.view.lrcview.ILrcView;
...
//    private int mNormalRowColor = Color.WHITE;
     ...
     **/
    private int mSeekLineTextSize = 45;
    /**
     ...
     **/
    private int mMaxSeekLineTextSize = 60;

    /**
     * 歌词字体大小默认值
     **/
    private int mLrcFontSize = 55;    // font size of lrc
    /**
     * 歌词字体大小最小值
     **/
     ...
     * 歌词字体大小最大值
     **/
    private int mMaxLrcFontSize = 80;
     ...
     * 当没有歌词的时候展示的内容
     **/
    private String mLoadingLrcTip = "暂无歌词内容";
...
//                    canvas.drawText(mLoadingLrcTip, width / 2, height / 2 - mLrcFontSize, mPaint);
                    canvas.drawText(mLoadingLrcTip, width / 2, (float) (height / 1.2), mPaint);
                }
                return;
            }
